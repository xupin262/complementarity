...
log_level = 'INFO'
load_from = 'work_dirs/mask2former_swin-l-in22k-384x384-pre_8xb2-160k_dfuc-512x512_nq2/iter_32000.pth'
resume = False
...
test_evaluator = dict(
    ...
    iou_metrics=['mIoU'],
    format_only=True,
    output_dir='work_dirs/test/mask2former_swin-l_nq2_newnew_32k',
    keep_results=True)
...
launcher = 'none'
work_dir = './work_dirs/mask2former_swin-l-in22k-384x384-pre_8xb2-160k_dfuc-512x512_nq2'
